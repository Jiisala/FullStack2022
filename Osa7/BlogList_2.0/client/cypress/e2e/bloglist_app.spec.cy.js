  ...
  describe('When logged in', function () {
    ...
    describe('and several blogs exist', function () {
      beforeEach(function () {
        ...
        cy.createBlog({
          title:
            'I should be Second blog, but am first cause I have one million likes',
          author: 'testaaja',
          url: 'http://www.hiding.com',
          likes: '1000000',
        })
      ...
      it('blogs are ordered by likes', function () {
        ...
        cy.createBlog({
          title:
            'I am a new blog but wont go first cause I have only seven likes',
          author: 'testaaja',
          url: 'http://www.hiding.com',
          likes: '7',
        })
        ...
        cy.createBlog({
          title:
            'I am a new blog and will go first cause I have million and one likes',
          author: 'testaaja',
          url: 'http://www.hiding.com',
          likes: '1000001',
        })
